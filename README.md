...
| `DRIFT_SEP_GAP_NEAR` | `3` | Empty rows between colon dots when near correct (< 10% of MAX) |
| `DRIFT_SEP_GAP_MID` | `4` | Empty rows when offset ≥ 10% of MAX |
| `DRIFT_SEP_GAP_FAR` | `5` | Empty rows when offset ≥ 33% of MAX |
